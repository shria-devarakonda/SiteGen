...
script = "<html> <head> <style> h1 {text-align: center;} p {text-align: center;} </style> </head> <body style=\"background-color:blueviolet;\"> <font color = \"#FF00CB\" face = \"Comic sans MS\" size = \"7\"><br /> <h1>"
